...
public class FourNearbyFragment extends BaseFragment implements OnBannerListener {
    ...
    private void initstorData(String type, String wdpt, String jdpt) {
        ...
        String nearbyMs = "http://app.tealg.com/api/app/Business.ashx?flag=mapbusiness&page=1&pageSize=4&pcid=0&type=&wdpt=39.892138&jdpt=116.323148";
    ...
    private void initProductData(int pagei, String rsKey) {
        //  String nearbyMs = "http://app.tealg.com/api/app/Product.ashx?flag=fjProduct&page=1&pageSize=4&rsKey=3M/s1FPSHG4=&type=1758;
        String nearbyMs = "http://app.tealg.com/api/app/Product.ashx?flag=fjProduct&page=" + pagei + "&pageSize=6&rsKey=" + rsKey + "&pcid=0&type=";
    ...
    public void onViewClicked() {
        ...
        intent.putExtra("NearbyFragment","4");
