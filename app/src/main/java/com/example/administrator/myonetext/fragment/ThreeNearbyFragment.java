...
public class ThreeNearbyFragment extends BaseFragment implements OnBannerListener {
    @BindView(R.id.more2)
    TextView more2;
    ...
    private void initProductData(int pagei, String rsKey) {
        //  String nearbyMs = "http://app.tealg.com/api/app/Product.ashx?flag=fjProduct&page=1&pageSize=4&rsKey=2D10FF618B6F466320FF5D324161FCA79FE3A69C1F0A97DB778C3AFBA6B2AED3&pcid=0&type=mmm;
        String nearbyMs = "http://app.tealg.com/api/app/Product.ashx?flag=fjProduct&page=" + pagei + "&pageSize=6&rsKey=" + rsKey + "&pcid=0&type=mmm";
       //"rsKey":"2D10FF618B6F466320FF5D324161FCA79FE3A69C1F0A97DB778C3AFBA6B2AED3"
    ...
    public void onViewClicked() {
        ...
        intent.putExtra("NearbyFragment","3");
