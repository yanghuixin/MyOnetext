...
public class AllSearchBean {
    ...
    private String Msg;
    private Objects sjmsg;
    private Objects cpmsg;
    ...
    public Objects getSjmsg() {
        return sjmsg;
    }

    public void setSjmsg(Objects sjmsg) {
        this.sjmsg = sjmsg;
    }

    public Objects getCpmsg() {
        return cpmsg;
    }

    public void setCpmsg(Objects cpmsg) {
        this.cpmsg = cpmsg;
    }
